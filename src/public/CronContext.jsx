...
const CronProvider = ({ children, tasks }) => {
  ...
  return <CronContext.Provider value={store}>{children}</CronContext.Provider>
}

CronProvider.propTypes = {
  tasks: PropTypes.array.isRequired
}

CronProvider.defaultProps = {
  tasks: defaultTasks
}

export { CronProvider, CronContext }
